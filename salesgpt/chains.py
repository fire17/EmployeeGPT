...
class SalesConversationChain(LLMChain):
    ...
    def from_llm(
        ...
        if use_custom_prompt:
            ...
            sales_agent_inception_prompt = employeePrompt
            prompt = PromptTemplate(
                template=sales_agent_inception_prompt,
                input_variables=[
                    "salesperson_name",
...
'''
TODO: NEXT STEPS
handle ooo hours, saturday, holidays, etc, calculate when it will open next, ask user if they would like to make an order for when they open 
external cart management
